      ...
      <div class="col-lg-12 order-1 order-lg-0">
        <div class="contact-area style-two pl-0 pr-0 pr-lg-4">
          <div class="section-title">
            <h3 style="text-align: center;">Sign In as <span>Doctor</span></h3>
          </div>
...
if(isset($_POST['login'])){
  ...
  $pass = $_POST['password'];
      ...
      $query ="SELECT * FROM doctor WHERE email='$email' &&  password='$pass'";
      ...
      { 
        ...
        header("location:admin_panel/doctor/profile_doctor.php");  
