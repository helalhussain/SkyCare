...
error_reporting(0);
 ...
 if($email==true)
 {
  ...
  $get_edit_id= $_GET['id'];
  $view_query="select * from doctor where id='$get_edit_id'";
  $view_run =mysqli_query($conn,$view_query);
  $view_profile = mysqli_fetch_assoc($view_run);
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Admin Dashboard / View Doctor Profile</h2>
                </div>
                              ...
                              <div class="card">
                                <div class="card-body">
                                  <div class="d-flex flex-column align-items-center text-center">
                                    <img src="<?php echo $view_profile['image']; ?>" alt="Admin" class="rounded-circle" width="150" height="145">
                                    <div class="mt-3">
                                      <h4><?php echo $view_profile['name']; ?></h4>
                              ...
                              <div class="card mb-3">
                                <div class="card-body">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                     <?php echo $view_profile['specialist']; ?>
                                    </div>
                                  </div>
                                  <hr>
                                  <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                     <?php echo $view_profile['address']; ?>
                                  </div>
                                  <hr>
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <a href="edit_doctor_pf_admin.php">
                                        <button class="btn-style-one" target="">Edit</button>
                                      </a>
                                    </div>
                                  </div>
                                </div>
