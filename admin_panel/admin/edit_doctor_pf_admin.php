        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Admin Dashboard / Edit Doctor Profile</h2>
                </div>
                              ...
                              <div class="card mb-3">
                                ...
                                <div class="card-body">
                                  <div class="row">
                                    ...
                                    <input class="form-control" type="text" value="<?php echo $edit_profile['name']; ?>" name="name" placeholder="Name" required>
                                    </div>
                                    </div>
                                  </div>
                                  <hr>
                                  <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <div class="form-group">
                                    <input class="form-control" type="number" name="phone" value="<?php echo $edit_profile['phone']; ?>" placeholder="Phone" required>
                                    </div>
                                    </div>
                                  </div>
                                  <hr>
                                  <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <div class="form-group">
                                    <input class="form-control" type="text" name="specialist" value="<?php echo $edit_profile['specialist']; ?>" placeholder="Specialty" required>
                                    </div>
                                    </div>
                                  </div>
                                  <hr>
                                  <div class="row">
                                   ...
                                   <div class="row">
                                    <div class="col-sm-12">
                                      <button class="btn-style-one"  type="submit" name="edit">Save</button>
                                    </div>
                                  </div>
