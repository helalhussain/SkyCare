                ...
                <div class="row g-3 my-2">
                    <div class="col-md-4">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <a href="add_doctor_admin.php">
                                    <h3 class="fs-2">Add</h3>
                                    <p class="fs-5">Doctors</p>
                                </a>
                            </div>
                            <a href="add_doctor_admin.php"><i class="fas fa-user-md fs-1 primary-text border rounded-full secondary-bg p-3"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <a href="add_patient_admin.php">
                                    <h3 class="fs-2">Add</h3>
                                    <p class="fs-5">Patients</p>
                                </a>
                            </div>
                            <a href="add_patient_admin.php"><i class="fas fa-user-injured fs-1 primary-text border rounded-full secondary-bg p-3"></i></a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <a href="add_department_admin.php">
                                    <h3 class="fs-2">Add</h3>
                                    <p class="fs-5">Department</p>
                                </a>
                            </div>
                            <a href="add_department_admin.php"><i class="far fa-building fs-1 primary-text border rounded-full secondary-bg p-3"></i></a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <a href="add_blog_admin.php">
                                    <h3 class="fs-2">Add</h3>
                                    <p class="fs-5">Blogs</p>
                                </a>
                            </div>
                            <a href="add_blog_admin.php"><i class="fas fa-keyboard fs-1 primary-text border rounded-full secondary-bg p-3"></i></a>
                        </div>
                    </div>
