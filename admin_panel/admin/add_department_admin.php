            ...
            <section style="margin-top: 50px;">
                ...
                <div class="row" style="max-width: 950px">
                    ...
                    <div class="contact-area style-two pl-0 pr-0 pr-lg-4">
                        ...
                        <h3 style="text-align: center;"><span> Add </span> Category </h3>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                  <input class="form-control" type="text" name="category" placeholder="Add New Department Here" required="">
                                </div>
                
                                <button type="submit" name="add_category" class="btn-style-one">Add</button>
                        ...
                        include("db.php");
                            ...
                            if(isset($_POST['add_category'])){
                                ...
                                $sql_category_query = "INSERT INTO category VALUE(NULL,'$category')";
                                $category_query = mysqli_query($conn,$sql_category_query);
