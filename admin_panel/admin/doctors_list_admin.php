    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="doctors_list_admin.php" class="list-group-item list-group-item-action bg-transparent second-text active"><i
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Admin Dashboard / Doctors List</h2>
                </div>
                          ...
                          <div class="table-wrapper">
                              ...
                              <?php 
                                    ...
                                    if(isset($_GET['sear']))
                                    {
                                        ...
                                        $query = "SELECT * FROM doctor WHERE CONCAT(specialist,city) LIKE '%$filtervalues%' ORDER BY id DESC";
                           ...
                           <tr class="bg-secondary text-white font-weight-bold">
                                       ...
                                       <td><?php echo $items['city']; ?></td>
                                          <td><?php echo $items['specialist']; ?></td>
                                           ...
                                           <td>
                                           <?php  echo "<a href='view_doctor_pf_admin.php?id=$items[id]'  class='view' title='View' data-toggle='tooltip'><i class='far fa-eye  text-white'></i></a>";?>
                                            <?php echo "<a href='edit_doctor_pf_admin.php?id=$items[id]' class='edit' title='Edit' data-toggle='tooltip'><i class='fas fa-pencil-alt'></i></a>"; ?>

                                           <?php echo "<a href='delete_doctor_admin.php?id=$items[id]' onclick='return checkdelete()' class='delete' title='Delete' data-toggle='tooltip'><i class='far fa-trash-alt  text-white'></i></a>" ?>
                                          </td>
                                      </tr> 
                                ...
                                while($doctor_list =mysqli_fetch_assoc($doctor_data)){?>
                                      ...
                                      <tr>
                                          ...
                                          <td><?php echo $doctor_list['city']; ?></td>
                                          <td><?php echo $doctor_list['specialist']; ?></td>
                                           <td><?php echo $doctor_list['phone']; ?></td>
                                          <td>
                                            
                                             <?php echo "<a href='view_doctor_pf_admin.php?id=$doctor_list[id]' class='view' title='view'><i class='far fa-eye'></i></a>"; ?>
                                            <?php echo "<a href='edit_doctor_pf_admin.php?id=$doctor_list[id]' class='edit' title='edit'><i class='fas fa-pencil-alt'></i></a>"; ?>
                                           <?php echo "<a href='delete_doctor_admin.php?id=$doctor_list[id]' onclick='return checkdelete()' class='delete' title='Delete' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>" ?>
                                          </td>
                                      </tr>
