...
$get_edit_id= $_GET['id'];
    ...
    $edit_query="select * from doctor where id='$get_edit_id'";
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Doctor Dashboard / Edit Profile</h2>
                </div>
                                ...
                                <div class="card-body">
                                  <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="mt-3">
                                      ...
                                      <p class="text-secondary mb-1"><?php echo $edit_profile['specialist']; ?></p>
                                      <p class="text-muted font-size-sm"><?php echo $edit_profile['address']; ?></p>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="card mb-3">
                                ...
                                <div class="row">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <div class="form-group">
                                    <input class="form-control" type="number" value="<?php echo $edit_profile['age']; ?>" name="age" placeholder="Age" required>
                                    </div>
                                    </div>
                                  </div>
                                  <hr>
                                  <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <div class="form-group">
                                    <input class="form-control" type="text" value="<?php echo $edit_profile['phone']; ?>" name="phone" placeholder="Phone" required>
                                    </div>
                                    </div>
                                  </div>
                                  <hr>
                                  <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <div class="form-group">
                                    <input class="form-control" type="text" value="<?php echo $edit_profile['specialist']; ?>" name="specialty" placeholder="Specialty" required>
                                    </div>
                                    </div>
                                  </div>
                                  <hr>
                                  <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <div class="form-group">
                                    <input class="form-control" type="text" value="<?php echo $edit_profile['address']; ?>" name="address" placeholder="Address" required>
                                    </div>
                                    </div>
                                  </div>
                                    <hr>
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <button class="btn-style-one" type="submit" name="edit_prof">Save</button>
                                    </div>
                                  </div>
...
if($current_password == null){
  ...
  $edit_query ="UPDATE doctor SET name='$name', phone='$phone', specialist='$specialist', address='$address'  WHERE id='$get_edit_id'";
  echo '<script>alert("Account Edit Success")</script>'; 

            $edit_sql = mysqli_query($conn,$edit_query);
        if($edit_sql){
        ?>
          <META HTTP-EQUIV="Refresh" CONTENT="0; URL=http://localhost/skycare/admin_panel/doctor/profile_doctor.php">
...
if(isset($_POST['change'])){
  ...
  $pass_query="select * from doctor where id='$get_edit_id'";
  ...
  $pass_profile = mysqli_fetch_assoc($pass_run);
   ...
   if($current_password== $pass_profile['password']){
    if($password != $confirm_password){
        ...
        $pass_edit_query ="UPDATE doctor SET password='$password'  WHERE id='$get_edit_id'";
...
if($current_password == null){
  ...
  $edit_query ="UPDATE doctor SET name='$name', phone='$phone', specialist='$specialty', age='$age',address='$address'  WHERE id='$get_edit_id='";
  echo '<script>alert("Account Edit Success")</script>'; 
