                              ...
                              <div class="card">
                                <div class="card-body">
                                  <div class="d-flex flex-column align-items-center text-center">
                                    <img src="../admin/<?php echo $view_profile['image']; ?>" alt="Admin" class="rounded-circle" width="150" height="147">
                                    <div class="mt-3">
                                      <h4> <?php echo $view_profile['name']; ?></h4>
                                      <p class="text-secondary mb-1"> <?php echo $view_profile['address']; ?></p>
                                      <p class="text-muted font-size-sm"> <?php echo $view_profile['specialist']; ?></p>
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="col-md-8">
                              <div class="card mb-3">
                                <div class="card-body">
                                  ...
                                  <div class="row">
                                    <div class="col-sm-3">
                                      <h6 class="mb-0"> <?php echo $view_profile['name']; ?></h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
