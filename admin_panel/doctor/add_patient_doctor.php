    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="add_patient_doctor.php" class="list-group-item list-group-item-action bg-transparent second-text active"><i
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Doctor Dashboard / Add Patient</h2>
                </div>
...
elseif(strlen($password) < 5 || strlen($password) > 20) {
 ...
 elseif(strlen($address) < 3 || strlen($address) > 50){
    echo "<script>$('.address_error').html('Last name must be 3 to 50 digits');</script>";
        ...
        if($query){
          ?>
            <META HTTP-EQUIV="Refresh" CONTENT="0; URL=http://localhost/SkyCare/admin_panel/doctor/patients_list_doctor.php">
