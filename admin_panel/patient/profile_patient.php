        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Patient Dashboard / Profile</h2>
                </div>
                                ...
                                <div class="card-body">
                                  <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="mt-3">
                                      ...
                                      <p class="text-secondary mb-1"><?php echo $result['blood']; ?></p>
                            ...
                            <div class="col-md-8">
                              <div class="card mb-3">
                                <div class="card-body">
                                  ...
                                  <div class="row">
                                    <div class="col-sm-12">
                                     <?php echo "<a  href='edit_profile_patient.php?id=$result[id]' class='btn-style-one' style='' title='Edit'>Edit</a>"; ?>
                                    </div>
                                  </div>
                                </div>
                              </div>
