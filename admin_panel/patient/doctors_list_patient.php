...
error_reporting(0);
 ...
 if($email==true)
 {
  ...
  // $doctor_sql="select * from doctor where email='$email'";
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Patient Dashboard / Doctors List</h2>
                </div>
                      ...
                      <div class="table-responsive">
                          <div class="table-wrapper">
                           ...
                           <tr>
                                         ...
                                         <td>
                                        <?php echo "<a  href='view_doctor_pf_patient.php?id=$items[id]' class='view' title='View' data-toggle='tooltip' style='display: inline-block; margin: 0 14px'><i style='font-size: 30px;' class='far fa-eye'></i></a>"; ?>
                                        <?php
                                          echo '<a href="appointment_patient.php?id=$items[id]" class="accept" title="Appoint" data-toggle="tooltip" style="display: inline-block; margin: 0 5px"><i style="font-size: 30px;" class="far fa-calendar-check"></i></a>'; ?>
                                          </td>
                                      </tr> 
                                ...
                                while($doctor_list =mysqli_fetch_assoc($data)){?>
                                      ...
                                      <tr>
                                          ...
                                          <td><?php echo $doctor_list['phone']; ?></td>
                                           <td><?php echo $doctor_list['age']; ?>/td>
                                          <td><?php echo $doctor_list['specialist']; ?>/td>
                               <td><?php echo $doctor_list['address']; ?>/td>
                                         <td>
                                        <?php echo "<a  href='view_doctor_pf_patient.php?id=$doctor_list[id]' class='view' title='View' data-toggle='tooltip' style='display: inline-block; margin: 0 14px'><i style='font-size: 30px;' class='far fa-eye'></i></a>"; ?>

                                            <?php
                                          echo "<a href='appointment_patient.php?id=$doctor_list[id]' class='accept' title='Appoint' data-toggle='tooltip' style='display: inline-block; margin: 0 5px'><i style='font-size: 30px;' class='far fa-calendar-check'></i></a>"; ?>
                                          </td>
                                      </tr>            
