...
if($email==true)
{
  header('location:admin_panel/patient/profile_patient.php');
}else{
        ...
        <div class="col-lg-12 order-1 order-lg-0">
          <div class="contact-area style-two pl-0 pr-0 pr-lg-4">
            <div class="section-title">
              <h3 style="text-align: center;">Sign In as <span>Patient</span></h3>
            </div>
            <form name="contact_form" class="default-form contact-form" action="" method="post">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <br>
                  <br>
                  <span Class="d-flex justify-content-center">If you don't have any accounts ,<a  style="color: #48bdc5;" href="registration.php">&nbsp;Sign up here</a></span>
